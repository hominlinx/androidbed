...
import com.uperone.zxing.camera.CameraManager;
import com.uperone.zxing.decoding.CaptureActivityHandler;
import com.uperone.zxing.decoding.InactivityTimer;
import com.uperone.zxing.view.ViewfinderView;
...
public class CaptureActivity extends BaseActivity implements Callback{
	...
	public void handleDecode(final Result obj, Bitmap barcode)
	{
		...
		if(!TextUtils.isEmpty( result ) ){
			System.out.println( "XXXXXXXXXXXXXxresult == " + result );
			String[] results = result.split( "#" );
			String user = "mytest";
			String password = "yuanguang";
			int type = 3;
